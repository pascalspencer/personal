...
function _getHistoricalData() {
  _getHistoricalData = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var historicalData;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.next = 2;
          return candle_stream.history({
            count: 100,
            end: yesterday
          });
        case 2:
          historicalData = _context.sent;
          return _context.abrupt("return", historicalData);
        case 4:
        case "end":
...
function extractFeatures(data) {
  ...
  var features = data.map(function (candle) {
    return candle.close;
  });
  return features;
}
...
function trainModel(features) {
  ...
  var x = features.map(function (val, index) {
    return [index];
...
function makePrediction(model, newData) {
  ...
  var prediction = model[0] + model[1] * (newData.length + 1); // Predict the next value
  return prediction;
}

// Putting it all together
function predictTrade() {
  return _predictTrade.apply(this, arguments);
} // Call the function to make a trade prediction
function _predictTrade() {
  _predictTrade = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    var historicalData, processedData, features, model, prediction;
