...
var connection = new WebSocket('wss://ws.derivws.com/websockets/v3?app_id=1089');
...
var contractsForSymbolResponse = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(res) {
    var data, _data$error, contractsData;
      ...
      while (1) switch (_context.prev = _context.next) {
        ...
        case 6:
          if (data.msg_type === 'contracts_for') {
            contractsData = data.contracts_for; // for (const contract of contractsData) {
  ...
  return function contractsForSymbolResponse(_x) {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          _context2.next = 3;
          return basic.contractsFor(contracts_for_symbol_request);
        case 3:
        case "end":
